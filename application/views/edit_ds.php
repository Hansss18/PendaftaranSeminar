...
>
  ...
  <body>
	...
	<?php
		echo form_open('pf_controller/update_pf');
		echo "<div class='col-md-6'>";
    echo "<div class='card-body'>";      		
		echo form_hidden('old_no',$old_no);
		echo form_label('Nama Seminar');
		echo form_input(array('id'=>'nmpst', 'class'=>'form-control','name'=>'namasmnr','value'=>$records[0]->namasmnr));
		echo "</div></div>";
    echo "<div class='col-md-6'>";
    echo "<div class='card-body'>"; 
		echo form_label('Tanggal Seminar');
    echo form_input(array('id'=>'nmpst', 'type'=>'date' ,'class'=>'form-control','name'=>'tglsminar','value'=>$records[0]->tglsminar));
    echo "</div></div>";
    echo "<div class='col-md-6'>";
    echo "<div class='card-body'>"; 	
		echo form_submit(array('id'=>'submit','value'=>'Edit', 'class'=>'btn rounded-pill btn-success'));
		echo form_close();
    ?>	
                </div>
              </div>
